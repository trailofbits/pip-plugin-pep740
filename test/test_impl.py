...
from pypi_attestations import AttestationBundle, GitLabPublisher
...
with DIST_FILE_1.open("rb") as f:
    DIST_DIGEST_1 = hashlib.file_digest(f, "sha256").hexdigest()

with DIST_FILE_2.open("rb") as f:
    DIST_DIGEST_2 = hashlib.file_digest(f, "sha256").hexdigest()

with DIST_FILE_3.open("rb") as f:
    DIST_DIGEST_3 = hashlib.file_digest(f, "sha256").hexdigest()
